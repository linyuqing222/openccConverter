...
addon_info = AddonInfo(
	...
	addon_summary=_("OpenCC Chinese Converter"),
	# Add-on description
...
pure-Python OpenCC engine; no internet connection is required."""),
	...
	addon_version="1.0.1",  # x-release-please-version
...
- The conversion direction is configurable in the add-on settings."""),
	...
	addon_url="https://github.com/linyuqing222/openccConverter",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/linyuqing222/openccConverter",
